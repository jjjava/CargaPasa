...
public class TempBenPASA {
    ...
    private String dataFimCarencia;
    ...
    public String getCategoriaPASA() {
        return categoriaPASA;
    }

    public void setCategoriaPASA(String categoriaPASA) {
        this.categoriaPASA = categoriaPASA;
    }
    ...
    public String getDataInicioCarencia() {
        return dataInicioCarencia;
    }

    public void setDataInicioCarencia(String dataInicioCarencia) {
        this.dataInicioCarencia = dataInicioCarencia;
    }

    public String getDataFimCarencia() {
        return dataFimCarencia;
    }

    public void setDataFimCarencia(String dataFimCarencia) {
    ...
    public String getDiasDeCarencia() {
        return diasDeCarencia;
    }

    public void setDiasDeCarencia(String diasDeCarencia) {
        this.diasDeCarencia = diasDeCarencia;
    }
